const INSTRUCTION_SET = [
  ...
  },
  {
    ...
    mask: 0xf000,
    pattern: 0x3000,
    arguments: [ { mask: 0x0f00, shift: 8, type: 'R' }, { mask: 0x00ff, shift: 0, type: 'KK' } ],
  },
  {
    key: 7,
    name: 'SNE',
  ...
  },
  {
    ...
    mask: 0xf00f,
    pattern: 0xf007,
    arguments: [ { mask: 0x0f00, shift: 8, type: 'R' }, { mask: 0x00ff, shift: 0, type: 'DT' } ],
  },
  {
    key: 28,
    name: 'LD',
    mask: 0xf00f,
    pattern: 0xf00a,
    arguments: [ { mask: 0x0f00, shift: 8, type: 'R' }, { mask: 0x00ff, shift: 0, type: 'Key' } ],
  },
  {
    key: 29,
    name: 'LD',
