describe('Instruction set tests', () => {
  ...
  test('Expect disassembler to match opcode 00E0 to instruction CLS', () => {
  ...
  test('Expect disassembler to match opcode 00EE to instruction RET', () => {
  ...
  test('Expect disassembler to match opcode 1nnn to instruction JP_ADDR', () => {
  ...
  test('Expect disassembler to match opcode 2nnn to instruction CALL_ADDR', () => {
  ...
  test('Expect disassembler to match opcode 3xkk to instruction SE_VX_NN', () => {
  ...
  test('Expect disassembler to match opcode 4xkk to instruction SNE_VX_NN', () => {
  ...
  test('Expect disassembler to match opcode 5xy0 to instruction SE_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 6xkk to instruction LD_VX_NN', () => {
  ...
  test('Expect disassembler to match opcode 7xkk to instruction ADD_VX_NN', () => {
  ...
  test('Expect disassembler to match opcode 8xy0 to instruction LD_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 8xy1 to instruction OR_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 8xy2 to instruction AND_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 8xy3 to instruction XOR_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 8xy4 to instruction ADD_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 8xy5 to instruction SUB_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 8xy6 to instruction SHR_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 8xy7 to instruction SUBN_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 8xyE to instruction SHL_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode 9xy0 to instruction SNE_VX_VY', () => {
  ...
  test('Expect disassembler to match opcode Annn to instruction LD_I_ADDR', () => {
  ...
  test('Expect disassembler to match opcode Bnnn to instruction JP_V0_ADDR', () => {
  ...
  test('Expect disassembler to match opcode Cxkk to instruction RND_VX_NN', () => {
  ...
  test('Expect disassembler to match opcode Dxyn to instruction DRW_VX_VY_N', () => {
  ...
  test('Expect disassembler to match opcode Ex9E to instruction SKP_VX', () => {
  ...
  test('Expect disassembler to match opcode ExA1 to instruction SKNP_VX', () => {
  ...
  test('Expect disassembler to match opcode Fx07 to instruction LD_VX_DT', () => {
  ...
  test('Expect disassembler to match opcode Fx0A to instruction LD_VX_K', () => {
  ...
  test('Expect disassembler to match opcode Fx15 to instruction LD_DT_VX', () => {
  ...
  test('Expect disassembler to match opcode Fx18 to instruction LD_ST_VX', () => {
  ...
  test('Expect disassembler to match opcode Fx1E to instruction ADD_I_VX', () => {
  ...
  test('Expect disassembler to match opcode Fx29 to instruction LD_F_VX', () => {
  ...
  test('Expect disassembler to match opcode Fx33 to instruction LD_B_VX', () => {
  ...
  test('Expect disassembler to match opcode Fx55 to instruction LD_I_VX', () => {
  ...
  test('Expect disassembler to match opcode Fx65 to instruction LD_VX_I', () => {
  ...
  test('Expect all other opcodes to match DW (Data Word)', () => {
